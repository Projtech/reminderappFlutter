...
import '../screens/privacy_settings_screen.dart'; // 👈 NOVO IMPORT
   ...
   return Drawer(
     child: ListView(
       ...
       children: [
         ...
         _buildConfigurationSection(isDark), // 👈 NOVA SEÇÃO
         const Divider(),
         _buildAboutItem(),
         _buildPrivacyItem(),
       ],
      ...
      builder: (context, snapshot) {
        ...
        return ListTile(
          ...
          onTap: () async {
            ...
            // 👈 FORÇA REBUILD para esconder o item após desabilitar
            if (mounted) setState(() {});
          },
        );
      },
